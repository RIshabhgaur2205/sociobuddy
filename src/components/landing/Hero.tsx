...
const Hero = () => {
  ...
  return <section className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="absolute top-1/2 -left-40 h-[400px] w-[400px] rounded-full bg-gradient-to-br from-teal/20 to-mint/30 blur-3xl animate-blob" style={{
      animationDelay: '-2s'
    }} />
      <div className="absolute bottom-20 right-1/4 h-[350px] w-[350px] rounded-full bg-gradient-to-br from-sunshine/25 to-lavender/20 blur-3xl animate-blob" style={{
      animationDelay: '-4s'
    }} />
      ...
      <div className="container relative mx-auto px-4 pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] animate-fade-in" style={{
            animationDelay: '0.1s'
          }}>
              Break Free From
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
            ...
            animationDelay: '0.3s'
              ...
              <Button variant="hero" size="xl" onClick={() => navigate("/auth")} className="group shadow-glow hover:shadow-[0_0_60px_hsl(var(--coral)/0.4)] transition-all duration-300">
                <Heart className="h-5 w-5 group-hover:scale-110 transition-transform" />
                Join SocioBuddy
                <ArrowRight className="h-4 w-4 ml-1 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="hero-outline" size="xl" onClick={scrollToHowItWorks} className="group">
            ...
            {/* Social proof */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 pt-6 animate-fade-in" style={{
            animationDelay: '0.4s'
          }}>
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4, 5].map(i => <div key={i} className="h-11 w-11 rounded-full border-3 border-background bg-gradient-to-br from-coral-light via-teal to-sunshine flex items-center justify-center text-primary-foreground text-xs font-bold shadow-md hover:scale-110 hover:z-10 transition-transform cursor-pointer" style={{
                ...
                <div>
                  <p className="font-extrabold text-2xl text-foreground">100+</p>
          ...
          animationDelay: '0.2s'
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border border-border/20">
                <img src={heroImage} alt="Diverse teenagers connecting and supporting each other" className="w-full object-cover" />
                {/* Shimmer overlay */}
